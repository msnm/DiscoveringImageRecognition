...
def train():
    ...
    model.add(Conv2D(32, (5, 5), padding='same', input_shape=(img_x, img_y, 1), activation="relu", activity_regularizer=l1(0.001)))
    model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))

    # Second conv
    model.add(layers.Conv2D(64, (5, 5), padding='same', activation='relu', activity_regularizer=l1(0.001)))
    model.add(Dropout(0.3))
    model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))

    # Third conv
    model.add(layers.Conv2D(96, (5, 5), padding='same', activation='relu', activity_regularizer=l1(0.001)))
    model.add(Dropout(0.3))
    model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))
...
def predict():
    ...
    loaded_model = models.load_model('/Users/mvrm/Documents/msnm/AI/DiscoveringImageRecognition/Captchas/output/model_chars1_acc_0_86/model.h5')
